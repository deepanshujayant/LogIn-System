...
public class New extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Deepanshu\\Downloads\\1498153168_back-alt.png")); // NOI18N
       ...
       Connection con=null;
        ...
        try {
            ...
            if (code == JOptionPane.YES_OPTION) {
                String query = "update logins set password = '"+(cpass)+"' where userid = " + (updatexid) ;
